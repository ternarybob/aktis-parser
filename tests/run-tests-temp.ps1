...
# Check service (optional - tests will skip if not running)
Write-Host "`nChecking if service is running..." -ForegroundColor Cyan
try {
    ...
    Write-Host "Service may not be running - tests will skip if endpoints unavailable" -ForegroundColor Yellow
}
